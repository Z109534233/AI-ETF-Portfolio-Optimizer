...
with st.sidebar:
    ...
    #
    # region_selector() / region_etf_multiselect() (src/ui.py) are the
    # SAME shared helpers used by Risk Analytics and AI Advisor: they read
    # and write one canonical st.session_state["selected_region"] /
