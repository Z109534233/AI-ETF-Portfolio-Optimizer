...
from src.ui import (
    ...
    render_footer, error_state, region_selector
)
...
with st.sidebar:
    ...
    # The ML pipeline itself (src/machine_learning.py) is fully ticker-
    # agnostic -- it only ever sees a price Series -- so no model code needs
    # to change to support new markets.
