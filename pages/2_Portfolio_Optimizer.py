    ...
    with st.expander(t("opt_bootstrap_title"), expanded=False):
        ...
        if _bootstrap_result is not None:
            ...
            if _bootstrap_summary is None:
                ...
                # Stable internal keys + explicit compact column widths keep the
                # 5-column summary inside the container without the unnecessary
                # horizontal scrollbar caused by auto-sized long headers.
